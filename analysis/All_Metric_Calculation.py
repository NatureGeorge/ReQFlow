...
if __name__ == "__main__":
    ...
    # inference_dir = '/data/zichong_data/rectify_qflow/scope/qflow_scope_linear_rectify_uniform/2025-01-21_21-24-47/epoch=204-step=92258/unconditional/run_2025-01-21_23-49-51'
    # script_path = '/home/zichong/QFlow/qflow/analysis/run_foldseek_parallel.sh'
    # dataset_dir = '/data/QFlow_Public_Data/FoldSeek/FoldSeek_PDB_Database'
    # pdb_list_dir = os.path.join(inference_dir, 'All_Sampled_PDB.txt')
